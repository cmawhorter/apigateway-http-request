...
var ApigatewayHttpBaseResponse = require('../src/main.js').ApigatewayHttpBaseResponse;

describe('ApigatewayHttpBaseResponse', function() {
  describe('#toJSON', function() {
    it('should return a properly formatted object', function() {
      var res = new ApigatewayHttpBaseResponse({ hello: 'world' }, 200, { 'some-header': 'some-header-value' }, 'req_1');
      var result = res.format();
